...
import blogo from "../img/tdLogo.png";
          ...
          >
            <div className="BAR">
              <Link to="/" className="navbar-brand">
                <img
                  src={blogo}
                  style={{ height: "250%", marginLeft: "15%" }}
                  alt="Logo"
                />
              </Link>
          ...
          <div className="groupedSectionStyle">
            <div className="newBox">
              <div className="tex">
                ...
                <span className="textbox"> TDM5</span>
              </div>
              <div className="otherStyle">
                  Unlock a revolutionary era of effortless employee management with TDM5's
                  dynamic dashboard. Engineered to simplify your managerial tasks, this
                  centralized hub promises seamless tracking of employee metrics and
                  effortless salary management, all with a touch of elegance.
              </div>
            </div>
